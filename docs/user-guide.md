...
`ethjs` is made from a series of smaller modules:
  ...
  - [`@metamask/ethjs-query`](http://github.com/MetaMask/ethjs-query) for querying the RPC layer
  - [`@metamask/ethjs-format`](http://github.com/MetaMask/ethjs-format) for formatting RPC payloads to and from the nodes
  - [`@metamask/ethjs-contract`](http://github.com/MetaMask/ethjs-contract) for handling contracts
  - [`@metamask/ethjs-abi`](http://github.com/MetaMask/ethjs-abi) for handling contract data encoding and decoding
  - [`@metamask/ethjs-filter`](http://github.com/MetaMask/ethjs-filter) for handling filters and events
  - [`@metamask/ethjs-unit`](http://github.com/MetaMask/ethjs-unit) for handling Ethereum currency unit conversion
  - [`@metamask/ethjs-util`](http://github.com/MetaMask/ethjs-util) general utiltity methods
  - [`@metamask/ethjs-provider-http`](http://github.com/MetaMask/ethjs-provider-http) a simple XHR http provider
